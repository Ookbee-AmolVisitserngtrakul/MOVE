                        ...
                        <Container>
                            ...
                            <Row>
                                <Col style={{ paddingTop: '15px', paddingBottom: '15px' }}>
                                    {'  '}<span style={{ fontSize: '16px' }}>30-08-20222 12:00</span>
                                </Col>
                            </Row>
                            <Row>
                                <Col><b>PREVIEW</b></Col>
                            ...
                            <Row>
                                <Col style={{ backgroundSize: '100%', backgroundImage: "url('" + process.env.PUBLIC_URL + "/mybooking/mystatus-bg-3.png')" }}>
                                    <Container style={{ padding: 0 }}>
                                        <Row>
                                            <Col style={{ paddingTop: '15px' }}>
                                        ...
                                        <Row>
                                            <Col style={{ paddingTop: '5px', paddingBottom: '20px' }}>
                                                <span style={{ fontSize: '10px' }}><b>Min./Loop:</b>  (22 minutes per 1 Available pack)</span>
                                            </Col>
                                        </Row>
                                    </Container>
                                </Col>
