  ...
  render () {
    ...
    return (
        <Container fluid style={{padding:0,margin:0}}>
            <div className='banner' style={{backgroundImage:"url('" + process.env.PUBLIC_URL + "/banner.jpg')"}}>
            </div>
            <Container style={{paddingTop:'1em'}}>
                ...
                <br/>
                <Row>
                    <Button href="/register" variant="dark" size="lg">สมัครขอกู้สินเชื่อเงินสด</Button>
                </Row>
                <br/>
                <Row>
                    <Col>
