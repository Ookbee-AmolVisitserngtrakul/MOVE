                        ...
                        <Container>
                            ...
                            <Row>
                                <Col style={{ paddingTop: '15px', paddingBottom: '15px' }}>
                                    <Button className='btn-status btn-status-Approved'>
                                        <img src={process.env.PUBLIC_URL + '/mybooking/mystatus-btn-Approved.png'} width='13px' style={{ borderRadius: '50px' }} /> Approved
