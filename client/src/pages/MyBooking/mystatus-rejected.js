...
class StatusRejected extends Component {
    constructor(props) {
        super(props)
    }
                        ...
                        <Container>
                            ...
                            <Row>
                                <Col style={{ paddingTop: '15px', paddingBottom: '15px' }}>
                                    <Button className='btn-status btn-status-Rejected'>
                                        <img src={process.env.PUBLIC_URL + '/mybooking/mystatus-btn-Rejected.png'} width='13px' style={{ borderRadius: '50px' }} /> Rejected
